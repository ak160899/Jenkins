...
public class Upgrade_yearly_premium79 extends Base {
	...
	private void $upgradeNow() throws InterruptedException {
		...
		/*
		 * try { WebElement updratelater =
		 * driver.findElement(By.xpath("(//button[@title='Upgrade Later'])[1]"));
		 * visbility(driver, updratelater, 60); click(updratelater); } catch (Exception
	...
	private void $premiumManageSubscription() throws InterruptedException, IOException {
		...
		$preplsdc = $drKp;
		System.out.println("premium user to dc :" + $preplsdc);
