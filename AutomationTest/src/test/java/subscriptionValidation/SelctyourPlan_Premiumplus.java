...
public class SelctyourPlan_Premiumplus extends Base {
	...
	private void activate$deac$lte() throws IOException, InterruptedException, NamingException, SQLException {
		...
		for (WebElement web : cnclacdrp1) {
			...
			if (web.getText().trim().equals("Cancel Subscription")) {
				...
				// Stripe.apiKey = "sk_test_DlgEc8SX53WLqUK9rbWN2kEC";
				// System.out.println("1");

				/*
				 * Map<String, Object> retrieveParams = new HashMap<>(); List<String> expand =
				 * new ArrayList<>(); expand.add("sources"); retrieveParams.put("expand",
				 * expand);
				 */
				// Customer customer = Customer.retrieve("cus_Mr1dRfpU1Nvew0", retrieveParams,
				// null);

				// Entity.getCon();

				// Connection con=Entity.getCon();
				// System.out.println("database connection: "+con);

				// Customer customer = Customer.retrieve("cus_Mr1dRfpU1Nvew0");
