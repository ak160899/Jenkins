...
public class Lite_end_Basic_Premium_premiumplus extends Base {

	public static WebDriver driver;
	static com.pageObjeman.PageObjMan pom;
	String $userKp;
	String $drKp;
	...
	public void lite() throws InterruptedException {
		 ...
		 * visbility(driver, $premiumyearlyToggle, 60); actions("click",
		 * $premiumyearlyToggle);
		 */
		sleep(5000);
	...
	private void activateDeactivateuser$bas$() throws InterruptedException, IOException {
		...
		WebElement $acusericon = driver.findElement(By.xpath("(//div[@id='divi-active-users'])[1]"));
