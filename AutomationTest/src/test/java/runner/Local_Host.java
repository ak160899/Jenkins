...
public class Local_Host extends Base {
	...
	public void HomeModule() throws Exception {
		...
		List<WebElement> genders = driver.findElements(By.xpath("(//ul[@id='gende12345rDropdown'])[1]/li"));
	...
	/*
	 * @AfterMethod public void checkTheStatusOfTheTest(ITestResult result) throws
	 * Throwable { if (ITestResult.FAILURE == result.getStatus()) { takeSnap();
	 * driver.quit(); }
	 * 
	 * }
	 */
